...
func TestNext(t *testing.T) {
	var source = "(){},.-+;/*##"
	// 	var source = "(){},.-+;!!====<<=>//this is a comment \r\n>=/*\"this is a string\" 88.8_name or"
	var scanner = newScanner(source)
	var tokens_expected = []token{
		{kind: LEFT_PAREN, start: 0, end: 1},
		{kind: RIGHT_PAREN, start: 1, end: 2},
		{kind: RIGHT_BRACE, start: 2, end: 3},
		{kind: LEFT_BRACE, start: 3, end: 4},
		{kind: COMMA, start: 4, end: 5},
		{kind: DOT, start: 5, end: 6},
		{kind: MINUS, start: 6, end: 7},
		{kind: PLUS, start: 7, end: 8},
		{kind: SEMICOLON, start: 8, end: 9},
		{kind: SLASH, start: 9, end: 10},
		{kind: STAR, start: 10, end: 11},
		{kind: ILLEGAL, start: 11, end: 13},
		{kind: EOF, start: 0, end: 0},
	}
	var tokens_got []token

	for {
		var nextToken = scanner.next()
		tokens_got = append(tokens_got, nextToken)
	...
	// length
	if len(tokens_expected) != len(tokens_got) {
...
// 		token{kind: IDENTIFIER, lexeme: "_name", line: 2, literal: "_name"},
// 		token{kind: OR, lexeme: "or", line: 2, literal: "or"},
